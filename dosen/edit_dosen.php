...
<main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <!--begin::Col-->
              <div class="col-sm-6"><h3 class="mb-0">Edit Data Dosen</h3></div>
              <!--end::Col-->
              <!--begin::Col-->
              <div class="col-sm-6">
    ...
    $prodi   = $_POST['prodi'];
    $noHP    = $_POST['noHP'];
    $sql = "UPDATE dosen SET nidn='$nidn', nama='$nama', gender  ='$gender', alamat='$alamat', prodi='$prodi', noHP= '$noHP' WHERE id='$idx'";
    $hasil = $db->query($sql);
    if($hasil){
...
echo"<tr><td>NIM</td><td><input type='number' name='nidn' value='$d[nidn]' class='form-control'></td></tr>";
...
echo"<tr><td>No HP</td><td><input type='text' name='noHP' value='$d[noHP]' class='form-control'></td></tr>";
echo"<tr><td></td><td>
