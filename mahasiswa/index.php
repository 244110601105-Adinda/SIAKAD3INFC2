        ...
        <ul class="navbar-nav ms-auto">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img
                      src="../assets/img/LOGO-INFORMATIKA.jpeg"
                      alt="User Image"
                      class="img-size-50 rounded-circle me-3" />
                  </div>
                  <div class="flex-grow-1">
                    <h3 class="dropdown-item-title">
                      informatika_uinsaizu
                      <span class="float-end fs-7 text-danger"><i class="bi bi-star-fill"></i></span>
                    </h3>
                    <p class="fs-7">mengirim pesan baru.</p>
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <p class="fs-7">Sudah baca pengumuman tadi?</p>
                    <p class="fs-7 text-secondary">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <p class="fs-7">Ada info penting untukmu!</p>
                    <p class="fs-7 text-secondary">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" data-bs-toggle="dropdown" href="#">
              ...
              <span class="navbar-badge badge text-bg-warning">10</span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              ...
              <a href="#" class="dropdown-item d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center flex-grow-1 min-w-0">
                  ...
                  <span class="notification-text">hmpsinf_uinsaizu baru saja memposting foto</span>
                </div>
                <span class="text-secondary fs-10 notification-time">3 mins</span>
              </a>
              <style>
                .notification-text {
                  white-space: nowrap;
              ...
              <a href="#" class="dropdown-item d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center flex-grow-1 min-w-0">
                  <i class="bi bi-envelope me-2"></i>
                  <span class="notification-text">demafds.uinsaizu menambahkan postingan baru</span>
                </div>
                <span class="text-secondary fs-10 notification-time">3 mins</span>
              </a>
              <style>
              ...
              <a href="#" class="dropdown-item d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center flex-grow-1 min-w-0">
                  <i class="bi bi-envelope me-2"></i>
                  <span class="notification-text">informatika_uinsaizu mulai mengikuti anda</span>
                </div>
                <span class="text-secondary fs-10 notification-time">3 mins</span>
              </a>
              <style>
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img
                ...
                alt="User Image" />
              <span class="d-none d-md-inline">UIN SAIZU</span>
            </a>
    ...
    <aside class="app-sidebar bg-primary shadow" data-bs-theme="dark">
      ...
      <div class="sidebar-brand">
        ...
        <a href="../index.html" class="brand-link">
          ...
          <!--end::Brand Image-->
          <!--begin::Brand Text-->
          <span class="brand-text fw-light">SI AKAD | UIN SAIZU</span>
          <!--end::Brand Text-->
        </a>
        <!--end::Brand Link-->
      </div>
